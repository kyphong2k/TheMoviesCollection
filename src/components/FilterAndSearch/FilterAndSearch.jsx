...
const FilterAndSearch = ({setFilterType, setPageNum}) => {
    ...
    <div className='pt-6 '>
        <div id="filter-and-search" className='mx-7 rounded bg-slate-900  max-w-[70%] flex-row flex gap-10 justify-between text-yellow-100'>
          ...
          <ul id='filter' className='w-[60%] h-full  pl-7 flex flex-row rounded gap-7 justify-center'>
            <li  onClick={() =>handleFilter('release_date.desc')} className='hover:cursor-pointer transition-all hover:ease-linear duration-300  group inline-block  px-4 text-lg font-bold py-3 hover:bg-slate-400 relative'>
              New <ChevronDownIcon className='h-5 w-5 inline-block'/>
              
            </li>
            <li onClick={() =>handleFilter('vote_average.desc')} className='hover:cursor-pointer transition-all hover:ease-linear duration-300   group inline-block  px-4 text-lg font-bold py-3 hover:bg-slate-400 relative'>
              Vote <ChevronDownIcon className='h-5 w-5 inline-block'/>
              
            </li>
            <li  onClick={() =>handleFilter('popularity.desc')} className='hover:cursor-pointer transition-all hover:ease-linear duration-300  group  inline-block  px-4 text-lg font-bold py-3 hover:bg-slate-400 relative'>
